...
public class CertRemarkRes {
    private ResponseHead head;
    private Object data;

    public CertRemarkRes() {
    }
    ...
    public boolean equals(Object o) {
        if (o == this) {
            return true;
        } else if (!(o instanceof CertRemarkRes)) {
            return false;
        } else {
            CertRemarkRes other = (CertRemarkRes)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof CertRemarkRes;
    }
    ...
    public String toString() {
        return "CertRemarkRes(head=" + this.getHead() + ", data=" + this.getData() + ")";
    }
}
