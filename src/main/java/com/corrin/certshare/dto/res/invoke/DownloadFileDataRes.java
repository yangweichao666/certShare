...
public class DownloadFileDataRes {
    private Integer total;
    private List<DownloadFileInfoRes> dataList;

    public DownloadFileDataRes() {
    }
    ...
    public List<DownloadFileInfoRes> getDataList() {
    ...
    public void setDataList(List<DownloadFileInfoRes> dataList) {
    ...
    public boolean equals(Object o) {
        if (o == this) {
            return true;
        } else if (!(o instanceof DownloadFileDataRes)) {
            return false;
        } else {
            DownloadFileDataRes other = (DownloadFileDataRes)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof DownloadFileDataRes;
    }
    ...
    public String toString() {
        return "DownloadFileDataRes(total=" + this.getTotal() + ", dataList=" + this.getDataList() + ")";
    }
}
