...
public class DownloadUrlRes {
    private ResponseHead head;
    private Object data;

    public DownloadUrlRes() {
    }
    ...
    public boolean equals(Object o) {
        if (o == this) {
            return true;
        } else if (!(o instanceof DownloadUrlRes)) {
            return false;
        } else {
            DownloadUrlRes other = (DownloadUrlRes)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof DownloadUrlRes;
    }
    ...
    public String toString() {
        return "DownloadUrlRes(head=" + this.getHead() + ", data=" + this.getData() + ")";
    }
}
